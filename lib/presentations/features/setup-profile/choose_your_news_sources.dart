...
import 'package:newsy/presentations/features/setup-profile/fill_your_profile_screen.dart';
import 'package:newsy/presentations/common_widgets/appbar/appbar.dart';
import 'package:newsy/presentations/common_widgets/choose_your_news_widget.dart';

import '../../common_widgets/bottom_navigation_btn.dart';
import '../../common_widgets/searchview/search_view_widget.dart' show SearchViewWidget;
...
class _ChooseYourNewsSourcesState extends State<ChooseYourNewsSources> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: TextStrings.chooseYourNewsSources),
      body: SafeArea(
      ...
      bottomNavigationBar: BottomNavigationItemBg(
        child: ElevatedButton(
          onPressed: _selectedSourceList.isNotEmpty
